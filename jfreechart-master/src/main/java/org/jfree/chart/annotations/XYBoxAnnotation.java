...
public class XYBoxAnnotation extends AbstractXYAnnotation
    ...
    /**
     * Método criado a partir da refabricação de um Long Method no método org.jfree.chart.annotations.XYBoxAnnotation.draw.
     * Creates and returns a rectangle according with the attributes.
     *
     * @param plot  the plot.
     * @param dataArea  the data area.
     * @param domainAxis  the domain axis.
